...
const ROOT_HELP: &str = concat!(
    ...
    "  --backend <name>               native, native-windows, native-linux-x11, native-macos, fake.\n",
...
const DOCTOR_HELP: &str = concat!(
    ...
    "  - On Windows, run from an unlocked interactive desktop; elevated or secure windows can reject input.\n",
